...
namespace RolaltyCardProject.Pages.AdminPanel.BusinessUsers
{
    ...
    public class IndexModel : PageModel
    {
        ...
        {
            Users = await CommonQuery.GetUsersSearchRoleAsync(_db, _userManager, Search, StaticDetails.BusinessEndUser);
        }
    }
}
